...
public class D_JInternalFrameTest {
    ...
    Action newAction = new AbstractAction("新建", new ImageIcon("ico/12_3/new.png")) {
        @Override
        public void actionPerformed(ActionEvent event) {
            ...
            if (nextFrameY + width > desktop.getWidth()) nextFrameX = 0;
    ...
    Action exitAction = new AbstractAction("退出",
            new ImageIcon("ico/12_3/exit.png")) {
        @Override
        public void actionPerformed(ActionEvent event) {
            System.exit(0);
        }
    ...
    public void init() {
        ...
        final var dragOutlineItem = new JCheckBoxMenuItem("仅显示拖动窗口的轮廓");
