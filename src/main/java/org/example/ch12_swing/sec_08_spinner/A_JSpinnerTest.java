package org.example.ch12_swing.sec_08_spinner;
...
public class A_JSpinnerTest {
    ...
    public void init() {
        ...
        // ----------指定最小值、最大值、布长的JSpinner----------
        // 创建一个SpinnerNumberModel对象，指定最小值、最大值和布长
        ...
        // 创建一个JSpinner.DateEditor对象，用于指定的Spinner进行格式化
        var editor = new JSpinner.DateEditor(spinners[5], "公元yyyy年MM月dd日HH时");
