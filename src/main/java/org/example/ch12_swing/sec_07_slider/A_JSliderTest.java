package org.example.ch12_swing.sec_07_slider;
...
public class A_JSliderTest {
    ...
    public void init() {
        ...
        labelTable.put(0, new JLabel(new ImageIcon("ico/12_7/0.GIF")));
        labelTable.put(20, new JLabel(new ImageIcon("ico/12_7/2.GIF")));
        labelTable.put(40, new JLabel(new ImageIcon("ico/12_7/4.GIF")));
        labelTable.put(60, new JLabel(new ImageIcon("ico/12_7/6.GIF")));
        labelTable.put(80, new JLabel(new ImageIcon("ico/12_7/8.GIF")));
        // 指定刻度标签，标签是ImageIcon
        slider.setLabelTable(labelTable);
