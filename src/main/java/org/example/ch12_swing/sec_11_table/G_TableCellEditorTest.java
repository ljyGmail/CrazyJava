...
public class G_TableCellEditorTest {
    JFrame jf = new JFrame("使用单元格编辑器");
    JTable table;
    // 定义二维数组作为表格数据
    Object[][] tableData = {
            new Object[]{"李清照", 29, "女", new ImageIcon("ico/12_11/3.gif"), new ImageIcon("ico/12_11/3.gif"), true},
            new Object[]{"苏格拉底", 56, "男", new ImageIcon("ico/12_11/1.gif"), new ImageIcon("ico/12_11/1.gif"), false},
            new Object[]{"李白", 35, "男", new ImageIcon("ico/12_11/4.gif"), new ImageIcon("ico/12_11/4.gif"), true},
            new Object[]{"弄玉", 18, "女", new ImageIcon("ico/12_11/2.gif"), new ImageIcon("ico/12_11/2.gif"), true},
            new Object[]{"虎头", 2, "男", new ImageIcon("ico/12_11/5.gif"), new ImageIcon("ico/12_11/5.gif"), false}
    };
    // 定义一维数据作为列标题
    ...
    public void init() {
        ...
        var model = new ExtendedTableModel2(columnTitle, tableData);
        ...
        // 创建JComboBox对象，并添加多个图标 列表项
        JComboBox<ImageIcon> editCombo = new JComboBox<>();
        for (var i = 1; i <= 10; i++) {
            editCombo.addItem(new ImageIcon("ico/12_11/" + i + ".gif"));
        }
    ...
    public static void main(String[] args) {
        new G_TableCellEditorTest().init();
    }
}
...
class ExtendedTableModel2 extends DefaultTableModel {
    ...
    // 重写getColumnClass方法,根据每列的第一个值返回该列真是的数据类型
...
class ImageCellEditor extends DefaultCellEditor {
    ...
    private void browse() {
        // 设置、打开文件选择器
        fDialog.setCurrentDirectory(new File("ico/12_11"));
        ...
        // 如果单击了文件选择器的"确定"按钮
            ...
            // 设置field的内容
            field.setText("ico/12_11/" + fDialog.getSelectedFile().getName());
        }
    }
}
