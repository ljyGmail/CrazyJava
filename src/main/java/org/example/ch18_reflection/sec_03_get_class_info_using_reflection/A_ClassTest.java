...
public class A_ClassTest {
    ...
    // 定义一个有参数的构造器
    public A_ClassTest(String name) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Class<A_ClassTest> clazz = A_ClassTest.class;
        // 获取该Class对象所对应的全部构造器
        ...
        Class inClazz = Class.forName("org.example.ch18_reflection.sec_03_get_class_info_using_reflection.A_ClassTest$Inner");
