...
public class B_VarHandleTest {
    public static void main(String[] args) throws Throwable {
        ...
        // 看到第三个元素被替换成Lua
        System.out.println(Arrays.toString(sa)); // [Java, Kotlin, Lua]
        // 获取sa数组的第二个元素
        System.out.println(avh.get(sa, 1)); // 输出Kotlin
        // 获取并设置：返回第三个元素，并将第三个元素设为Swift
        System.out.println(avh.getAndSet(sa, 2, "Swift")); // 输出Lua
        // 看到第三个元素被替换成Swift
        System.out.println(Arrays.toString(sa)); // [Java, Kotlin, Swift]
